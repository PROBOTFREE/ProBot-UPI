...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(String str, String str2, int i10) {
            return addCustomAction(new CustomAction(str, str2, i10, (Bundle) null));
        }
    ...
    public long getCurrentPosition(Long l10) {
        return Math.max(0, this.mPosition + ((long) (this.mSpeed * ((float) (l10 != null ? l10.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime)))));
    }
    ...
    public Object getPlaybackState() {
        ...
        if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
            ...
            long j11 = this.mBufferedPosition;
            float f10 = this.mSpeed;
            long j12 = this.mActions;
            CharSequence charSequence = this.mErrorMessage;
            long j13 = this.mUpdateTime;
            if (i10 >= 22) {
                obj = PlaybackStateCompatApi22.newInstance(i11, j10, j11, f10, j12, charSequence, j13, arrayList2, this.mActiveItemId, this.mExtras);
            } else {
                obj = PlaybackStateCompatApi21.newInstance(i11, j10, j11, f10, j12, charSequence, j13, arrayList2, this.mActiveItemId);
            }
            this.mStateObj = obj;
        }
