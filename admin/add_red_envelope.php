...
$role=mysqli_fetch_array($query);
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Envelope</h1>
      <ol class="breadcrumb">
        <li><a href="red_envelope.php"><i class="fa fa-dashboard"></i> Manage Envelope</a></li>
        <li class="active"><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Red Envelope</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
		 ...
		 <?php 
				if((@$_GET['msg'])=="ins") 
				{ ?>
              <font size="+2" color="#FF0000">Envelope added successfully......</font>
              <?php  } ?></h3></div>
            ...
            <?php
                  ...
                  $username='starwing_wingo';
                  $password='starwing_wingo';
                  $dbname = "starwing_wingo";
                ...
                {  
                   ...
                   $sql = "INSERT INTO tbl_envelope (amount,limits,ex_date)
                   VALUES ('$amount','$limits','$ex_date')";
                   if (mysqli_query($conn, $sql)) {
                    echo " Envelope added successfully...... !";
                   } else {
                    echo "Error: " . $sql . "
                " . mysqli_error($conn);
                   }
      ...
      <form  method="post" action="">
            ...
            <input type="hidden" name="limits" value="100" class="form-control">
            <label><b>EXPIRY Date *</b></label>
            <input type="date" name="ex_date" class="form-control"><br>
               <div style="text-align: center;">
                <input type="submit" name="save" style="background: #dd4b39; border: none; color: #fff; font-size: 30px; text-transform: uppercase; letter-spacing: 7px; padding: 5px 25px;">
               </div>
          </form>
            <!-- /.box-body -->
          </div>
