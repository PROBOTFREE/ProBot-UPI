 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  $total+=$row['amount'];?>  
                  <tr>
                    ...
                    <td><a style="background-color:#F5F5F5; color:black; font-size:16px; padding: 7px;" href="user-details.php?user=<?php echo @$row["userid"]; ?>" >Check User</a></td>
